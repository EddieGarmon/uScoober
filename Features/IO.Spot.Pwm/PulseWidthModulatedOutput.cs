...
using SpotPwm = Microsoft.SPOT.Hardware.PWM;
...
namespace uScoober.IO.Spot
{
                                             ...
                                             IPulseWidthModulatedOutput
    {
        ...
        public PulseWidthModulatedOutput(Cpu.PWMChannel pwmChannel, string id = null) {
            _pwm = new SpotPwm(pwmChannel, 100000u, 0, PWM.ScaleFactor.Nanoseconds, false);
